...
export class StorageManager {
    ...
    getDefaultSpots() {
        return [
            ...
            //PUURS (20 spots)
            new Spot(21, 'Park Fort Liezele', 'park', 'Mooi park met historisch fort en wandelpaden.', 51.0410, 4.2720, 'HangzDemo', [4,4,5], null),
            ...
            new Restaurant(24, 'Broox', 'Vers bereid eten met kwaliteit ingrediënten.', 51.0400, 4.2690, 'HangzDemo', [4,4,5], null, 'Modern'),
            new Restaurant(25, 'PuursFOOD', 'Lekker eten voor de hele familie.', 51.0415, 4.2780, 'HangzDemo', [5,4,5], null, 'Mixed'),
            new Spot(26, 'Bibliotheek Puurs', 'bibliotheek', 'Moderne bibliotheek met digitale diensten.', 51.0425, 4.2705, 'HangzDemo', [4,5,4], null),
            new Spot(27, 'Café De Vierklaver', 'koffie', 'Gezellig café met bruine kroeggevoel.', 51.0410, 4.2735, 'HangzDemo', [4,5,5], null),
            new Spot(28, 'STEPP Padel Tennis Club', 'activiteit', 'Moderne padel tennis club met professionele banen.', 51.0440, 4.2740, 'HangzDemo', [4,4,5], null),
            new Gym(29, 'Cross Gym', 'Intensieve crossfit en functionaltraining.', 51.0395, 4.2725, 'HangzDemo', [4,4,5], null, true),
            new Spot(30, 'Seinhuisje Puurs', 'station', 'Charmant historisch seinhuisje voor treinliefhebbers.', 51.0435, 4.2760, 'HangzDemo', [5,4,5], null),
            new Spot(31, 'Kalfort Puursica', 'activiteit', 'Sportcomplexe met meerdere sportterreinen.', 51.0405, 4.2695, 'HangzDemo', [4,4,5], null),
            new Spot(32, 'Knabbel en Babbel', 'broodje', 'Broodjeszaak met verse ingrediënten.', 51.0420, 4.2710, 'HangzDemo', [4,4,4], null),
            new Spot(33, 'Snack Grace', 'broodje', 'Lekker broodje en snacks.', 51.0430, 4.2750, 'HangzDemo', [4,4,4,5], null),
            new Restaurant(34, 'Kassita', 'Heerlijke Marokkaanse keuken en tajines.', 51.0415, 4.2745, 'HangzDemo', [5,4,5], null, 'Marokaans'),
            new Spot(35, 'The Binder', 'bioscoop', 'Bioscoop en theater in voormalig begijnhof.', 51.0380, 4.2680, 'HangzDemo', [4,5,4], null),
            new Spot(36, 'Muziekschool Campus Begijnhof', 'muziek', 'Professionele muziekles en studio\'s.', 51.0450, 4.2700, 'HangzDemo', [4,4,4,5], null),
            new Spot(37, 'Sjabi', 'koffie', 'Trendy koffiebar met broodjes.', 51.0390, 4.2770, 'HangzDemo', [4,4,4], null),
            new Spot(38, 'Rode Blok', 'activiteit', 'Creatief centrum met workshops en kunst.', 51.0425, 4.2720, 'HangzDemo', [4,5,4], null),
